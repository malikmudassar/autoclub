        ...
        <div class="row">
            ...
            <div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 text-center">
                <div class="wow fadeInUp section-title" data-wow-delay="0.6s">
                    <h2>Checkout the Dreams to come true<small>Ever wonder you could do these things if you could</small></h2>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="feature-thumb">
                    ...
                    <h3>Visa/Papers</h3>
                    <p>No wonder with a swell back account and heavy transactions who will say no to a corporate guest to visit their country.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.6s">
                <div class="feature-thumb">
                    ...
                    <h3>Hotel Booking</h3>
                    <p>With some serious pockets, you never stay a loner. Lets get out and stay at some the luxurious and fabulous hotels worldwide.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.9s">
                <div class="feature-thumb">
                    ...
                    <h3>Luxury</h3>
                    <p>Bonfire, BBQ, Grills, snakes and bottle of your favorite drinks. Lets see how can you resist your urges when you have cash.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="feature-thumb">
                    ...
                    <h3>Shopping</h3>
                    <p>Girlish thoughts. Brands Brands and Brands. Will you wait for a Sale or Will you buy the fresh launch before someone else could?</p>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.6s">
                <div class="feature-thumb">
                    ...
                    <h3>Sport</h3>
                    <p>Are you fitness nut? Wanna play cricket or climb on high cliffs or may be deep water diving can thrive up the adrenaline in you.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.9s">
                <div class="feature-thumb">
                    ...
                    <h3>Support</h3>
                    <p>No wonder Charity is a holy thing and everybody wishes to be able to do some. How good it will feel when you are a regular donar.</p>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="media wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="media-body">
                        <h3 class="media-heading">London</h3>
                ...
                <div class="media wow fadeInUp" data-wow-delay="0.9s">
                    ...
                    <div class="media-body">
                        <h3 class="media-heading">Paris</h3>
            ...
            <div class="col-md-6 col-sm-12">
                <div class="media wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="media-body">
                        <h3 class="media-heading">New York</h3>
                ...
                <div class="media wow fadeInUp" data-wow-delay="0.9s">
                    ...
                    <div class="media-body">
                        <h3 class="media-heading">Hong Kong</h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                ...
                <textarea class="input_field input_field-hoshi" rows="1"></textarea>
						<label class="input_label input_label-hoshi input_label-hoshi-color-1" for="input-4">
                            <span class="input_label-content input_label-content-hoshi">Address</span>
                        </label>
				</span>
